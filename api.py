...
def recomendar():
    ...
    if criterio == "duracao":
        ...
        candidatos = candidates = candidatos[candidatos["duracao_min"] <= float(duracao_max)]
    ...
    colunas = ["titulo", "genero", "duracao_min", "avaliacao", "ano",
               "popularidade", "score_recommendacao"]
    
    
    if "score_recomendacao" in candidatos.columns:
        colunas[-1] = "score_recomendacao"
